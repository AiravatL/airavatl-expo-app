/*
  # Fix auction winner relationships

  1. Changes
    - Drop and recreate foreign key constraints for winner relationships
    - Ensure proper relationship between auctions and profiles tables
